...
<STRONG> <FONT  SIZE=4 COLOR=#000055>WHAT WOULD CHANGE <br>
IF CORPORATIONS LOST PERSONHOOD?
</font><br>
by William Meyers</STRONG><br>
Supplement to <a href="http://www.iiipublishing.com/afd/santaclara.html" target="_blank">Santa Clara Blues: Corporate Personhood
v. Democracy</a>
<br>
...
<blockquote><em>We are talking here about personhood under the 14th Amendment
...
under the law.</em></blockquote>
<strong>
<P>There are two broad areas that could change. One is directly
...
as a legal principle in 1886.</P>

<P>Fortunately we do have a road map of sorts, a mirror image
of this issue. In 1896 the U.S. Supreme Court, in Plessy v. Ferguson,
effectively declared that "Negros" were not protected by the
...
Court ruled so that suddenly "Negroes" again became full legal
...
change its mind in 1956.</P>

<P>Were African-Americans (and others classified as non-white)
...
is not yet complete.</P>

<P>When corporate personhood is terminated, whether it be by a
...
of color after Brown v. Board of Education.</P>

<P>Just as in 1956 you could predict that, finally guaranteed
...
<P>Corporate personhood is at the root of such Supreme Court rulings
...
or indirectly affect the political process, should be prohibited.</P>

<P>Later in this essay the secondary effects of removing corporations
...
<P>Without the protection of the 14th Amendment, corporations
...
corporations appeals to the courts).</P>

<P>Without personhood the due process used for corporations could
...
series of appeals and diversionary legal filings.</P>

<P>Another example would be that corporate charters, granted by
...
consumer safety, or labor laws.</P>

<P>Another important constitutional "right" given to corporations is
protection under the 4th Amendment, which states, "<I>The
right of the people to be secure in their persons, houses, papers,
and effects, against unreasonable searches and seizures, shall
not be violated, and no warrants shall issue, but upon probable
cause, supported by oath or affirmation, and particularly describing
the place to be searched, and the persons to be seized</I>."<br>
<br>
 The key Supreme Court decision
...
very hard to give the 5th Amendment right that "nor
...
to testify against other persons.</P>

<P>The importance of the 4th Amendment right of corporate persons
...
rules need fear a surprise inspection.</P>

<P>Revoking corporate personhood would allow the government to
...
legitimate businesses and corporations who are obeying the law.</P>

<P>We now return to the possible secondary results of ending corporate
personhood and getting corporations out of the political process.</P>

<P>With corporations out of the political process the whole nature
...
for money to buy votes.</P>

<P>The main roadblock to single-payer, national health care has
...
<P>Ending corporate personhood is no more a magic-bullet than
